...
#> alpha  0.3  
#> 2024-10-22 16:42:51: dataframe = mtcars nsim = 30 num.trees = 10000. Running step 1
#> Variables remaining:  10 
#> alpha  0.1  
#> 2024-10-22 16:42:56: dataframe = mtcars nsim = 100 num.trees = 10000. Running step 1
#> 2024-10-22 16:43:04: dataframe = mtcars nsim = 100 num.trees = 10000. Running step 50
#> 2024-10-22 16:43:11: dataframe = mtcars nsim = 100 num.trees = 10000. Running step 100
#> Variables remaining:  9 
#> alpha  0.05  
#> 2024-10-22 16:43:12: dataframe = mtcars nsim = 150 num.trees = 10000. Running step 1
#> 2024-10-22 16:43:19: dataframe = mtcars nsim = 150 num.trees = 10000. Running step 50
#> 2024-10-22 16:43:27: dataframe = mtcars nsim = 150 num.trees = 10000. Running step 100
#> 2024-10-22 16:43:35: dataframe = mtcars nsim = 150 num.trees = 10000. Running step 150
...
#>   varname quantile_pooled      p_unadj   p_adj_FDR  p_adj_FWER Type1_confirmed FDR_confirmed FWER_confirmed
#> 1     cyl       0.9992598 0.0007401925 0.002467308 0.007401925               1             1              1
#> 2    qsec       0.9992598 0.0007401925 0.002467308 0.007401925               1             1              1
#> 3     mpg       0.9985196 0.0014803849 0.002467308 0.011843079               1             1              1
#> 4    disp       0.9985196 0.0014803849 0.002467308 0.011843079               1             1              1
#> 5      hp       0.9985196 0.0014803849 0.002467308 0.011843079               1             1              1
#> 6    carb       0.9985196 0.0014803849 0.002467308 0.011843079               1             1              1
#> 7      wt       0.9822354 0.0177646188 0.025378027 0.071058475               1             1              0
#> 8    drat       0.9252406 0.0747594375 0.093449297 0.224278312               0             0              0
#> 9    gear       0.9030348 0.0969652110 0.107739123 0.224278312               0             0              0
...
#>        mpg      cyl     disp       hp     qsec     carb       wt      drat     gear mpg_permuted cyl_permuted disp_permuted hp_permuted
#> 1 32.96580 37.83467 34.28494 44.40825 69.39776 24.06262 15.92240  6.592342 5.764364    -6.069204  -3.32899537    -8.1562793    7.681771
#> 2 33.94531 37.67475 33.80626 43.52956 69.47350 22.87792 15.14960 11.407349 4.598629     4.078202   2.89716983    13.9188568   18.325314
#> 3 30.08375 37.37923 35.83397 45.54814 63.48126 21.02905 19.53125  9.903495 6.940662    -3.242185   2.70553361     4.3478057   -1.002965
#> 4 32.87286 37.27228 33.33198 44.62708 66.72462 21.53476 16.72543 12.559785 8.191079     8.515609  -0.06092051     0.2708662   -5.778261
#> 5 33.31543 37.87766 35.51419 46.53287 68.73776 23.26442 16.94575 11.323333 7.602294    -5.753136   0.34546070    -4.3777628    3.339719
#> 6 32.14069 37.56510 34.74886 45.31037 67.73211 22.76118 17.46005 10.717524 7.541206    -5.267411  -0.50446983    -4.0950592   -1.733074
#>   qsec_permuted carb_permuted wt_permuted drat_permuted gear_permuted
#> 1     16.844710    -3.2699946   -6.661017     -2.508818     3.3687412
#> 2     -4.697359    -2.8813075   -1.537203     -8.378585    -1.6538532
#> 3     -3.033623    -4.7045122    9.585241     28.771112     7.1048423
#> 4      2.359071    11.3272227    2.210888      1.430094    -2.1331894
#> 5     16.449674     0.8828882   -6.429090     -4.002469     0.4812786
#> 6     -5.538990     0.1989782   -6.730972     -6.458763    -2.7823118
