...
vimp_def <- shadow_vimp(data = data_sub, outcome_var = "diagnosis", niters = c(20, 30, 50))
```
...
vimp_fdr <- shadow_vimp(data = data_sub, outcome_var = "diagnosis", niters = c(20, 30, 50), to_show = "FDR")
vimp_fdr

# Show only unadjusted p-values
vimp_unadjusted <- shadow_vimp(data = data_sub, outcome_var = "diagnosis", niters = c(20, 30, 50), to_show = "unadjusted")
vimp_fdr
```
...
````{r per_variable}
vimp_per_variable <- shadow_vimp(data = data_sub, outcome_var = "diagnosis", niters = c(20, 30, 50), method = "per_variable")
...
if (is_interactive) {
  ...
  vimp_parallel1 <- shadow_vimp(data = data_sub, outcome_var = "diagnosis", niters = c(20, 30, 50), num.threads = num_cores)
} else {
  # When non-interactive - run sequantial
  vimp_parallel1 <- shadow_vimp(data = data_sub, outcome_var = "diagnosis", niters = c(20, 30, 50))
}
````
...
if (is_interactive) {
  ...
  # When non-interactive - run sequantial
  vimp_parallel2 <- shadow_vimp(data = data_sub, outcome_var = "diagnosis", niters = c(20, 30, 50))
}
````
