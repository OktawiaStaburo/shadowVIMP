...
The `shadowVIMP` package is not (yet!) available on Cran. You can install the development version like this:
...
A more realistic and detailed example of how to use this package can be found in `vignette("shadowVIMP-vignette")`.
